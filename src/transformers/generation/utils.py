...
class GenerationMixin(ContinuousMixin):
    ...
    def _sample_klcl(
        ...
        **model_kwargs,
        ...
        This is the Kullback-Leibler Context Learning (KLCL) version of the sampling method. We periodically compress
        the context into the model's weights during generation by optimizing the KL divergence between a model with 
        a fuller context and a model with only a smaller window of recent tokens.
